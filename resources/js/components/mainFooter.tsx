...
const Footer = () => {
  // Clase para el fondo oscuro sólido (puedes usar bg-[#111827] para negro azulado)
  const bgStyle = "bg-neutral text-neutral-content"; 

  return (
    <div className={`${bgStyle} w-full mt-auto`}>
      {/* SECCIÓN 1: Links Organizados */}
      ...
      {/* SECCIÓN 2: Copyright y Socials con borde superior */}
      <footer className="footer border-t border-base-content/10 px-10 py-4 max-w-7xl mx-auto">
